...
class _ChooseLocationState extends State<ChooseLocation> {
  List<WorldTime> locations = [
    WorldTime(url: 'Asia/Kolkata', flag: 'india.png', location: 'Delhi'),
    WorldTime(url: 'Europe/London', flag: 'uk.png', location: 'London'),
    WorldTime(
        url: 'Europe/Berlin', flag: 'germany.png', location: 'Berlin/Franfurt'),
    ...
    WorldTime(url: 'Asia/Jakarta', flag: 'indonasia.png', location: 'Jakarta')
  ];
